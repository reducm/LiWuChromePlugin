...
$(document).ready(function(){
  ...
  $("#content").on("click", "#showtime" ,function(){
  ...
  $("#content").on("click", "#lshowtime", function(){
    if($(this).prop("checked")){		
  ...
  $("#content").on("click", "#lshowauthor", function(){
    if($(this).prop("checked")){
  ...
  $("#content").on("click", "#niming", function(){
    if($(this).prop("checked")){
  ...
  $("#onlyLouPig").on("click", onlyLouPig);
  $("#onlyta").on("click", onlyTa);
  $("#reverse").on("click", reverse);
  $("#resizePic").on("click", resizePic);
  $("#onlyPic").on("click", onlyPic);
  $("#onlyVideo").on("click", onlyVideo);
  $("#yama").on("click", yama);
  $("#onlyYama").on("click", onlyYama);
  $("#jumpSelf").on("click", jumpSelf);
  $("#zlPucker").on("click", zlPucker);
  $("#yyPucker").on("click", yyPucker);
  $("#digHole").on("click", digHole);
  $("#normal").on("click", normal);
  $("#testS").on("click", testS);
  $("#fromHighToLow").on("click", fromHighToLow);
  $("#fromLowToHigh").on("click", fromLowToHigh);
  $("#lnormal").on("click", lnormal);
